...
url: /projects/
---
Things I built or helped build, newest first. Full-time, freelance and side projects mixed.
...
- [GitGossip v0.2](https://github.com/osmangoninahid/gitgossip)
    - v0.2 of my CLI that writes commit messages and summaries from git history. On [PyPI](https://pypi.org/project/gitgossip/) and Homebrew.
...
- [configurable-http-proxy (JupyterHub)](https://github.com/jupyterhub/configurable-http-proxy)
    - Added a Redis-backed route store so routes survive proxy restarts. [Commit d739434](https://github.com/osmangoninahid/configurable-http-proxy/commit/d739434).
    - Tech Stack: `Node.js`, `Redis`, `Jasmine`

- [modelaudit (promptfoo)](https://github.com/promptfoo/modelaudit)
    - Fixed a false positive where a SafeTensors header byte was read as a pickle opcode. [Commit 6d70f50](https://github.com/osmangoninahid/modelaudit/commit/6d70f500).
    - Tech Stack: `Python`, `pytest`

### 2025

- [Engine Fabric](https://openinnovation.ai/enginefabric/) (formerly OICM) — *Open Innovation AI, Abu Dhabi*
    - The platform that runs AI workloads on GPU clusters. I lead initiatives of platform engineering and MLOps backend: GPU scheduling, multi-tenant storage and quotas, multi-cluster operations.
    - My areas: GPU scheduling and MIG; model serving and inference autoscaling; multi-tenant storage and quotas across NFS and S3-compatible vendors; GPU observability across clusters; GitOps, CI/CD pipelines, release automation and developer tooling.
...
- [GitGossip](https://github.com/osmangoninahid/gitgossip)
    - An open-source CLI that turns git history into readable summaries of commits and merge requests. Small service layer, pluggable LLM backends, Typer + Rich front end.
