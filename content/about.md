...
Today I work at [Open Innovation AI](https://openinnovation.ai) in Abu Dhabi on [OICM](https://openinnovation.ai/open-innovation-cluster-manager/), a platform that runs AI workloads on GPU clusters. I own the storage side of it and I build the security scanning for model files. Most of my day is Python, Go and Kubernetes.
