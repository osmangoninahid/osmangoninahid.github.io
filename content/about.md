...
Today I work at [Open Innovation AI](https://openinnovation.ai) in Abu Dhabi as a tech lead on [Engine Fabric](https://openinnovation.ai/enginefabric/), a platform that runs AI workloads on GPU clusters. I work across the platform: model deployment and inference, GPU scheduling and MIG, multi-cluster operations, distributed storage. These days most of my time goes to the storage side: multi-tenant volumes, quotas, S3-compatible backends.
