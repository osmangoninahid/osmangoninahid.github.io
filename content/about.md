...
Today I work at [Open Innovation AI](https://openinnovation.ai) in Abu Dhabi as a tech lead on [OICM](https://openinnovation.ai/open-innovation-cluster-manager/), a platform that runs AI workloads on GPU clusters. I do platform engineering and MLOps across the whole thing: model deployment and inference, GPU orchestration and scheduling (including MIG), multi-cluster operations, monitoring, storage and quotas, and security scanning for model files. Lately most of my time goes to storage. Most of my day is Python, Go and Kubernetes.
...
I write here about problems I hit at work, how we solved them, and what I would do differently.
...
[osmangoni.se@gmail.com](mailto:osmangoni.se@gmail.com)

## More

- [Projects](/projects/)
- [Open source](/os-contributions/)
- [Uses](/uses/)
- [GitHub](https://github.com/osmangoninahid) · [LinkedIn](https://www.linkedin.com/in/osmangoninahid)
