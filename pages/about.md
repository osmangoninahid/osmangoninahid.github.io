...
permalink: /about/
---
I’m a **Backend & Platform Engineering Leader** with over 10+ years of professional experience, building products from the ground up and scaling them to serve millions of users worldwide. I began my full-time career in 2014, and since then, I’ve worked across diverse industries — including B2B/B2C marketplaces, e-commerce, social commerce, fintech, logistics/3PL, messaging/XMPP, SaaS, and PaaS — often joining early-stage startups as a founding engineer and helping them evolve into large-scale, mature engineering organizations.

Over the past decade, I’ve designed and developed **high-performance backend systems**, focusing on **solution architecture, scalability, and distributed design patterns**. My expertise lies in building and maintaining **high-throughput, fault-tolerant systems** that power mission-critical platforms. I have more than **8 years of hands-on experience with NodeJS** and deep expertise in **Python**, while also exploring **Golang** and possessing production experience with **Erlang/OTP** for real-time messaging systems (XMPP). I’m highly experienced in **AWS** and comfortable working with **Azure** as well. I follow modern DevOps principles and practices, using tools like **Kubernetes, Docker, Terraform, and CI/CD pipelines**, along with observability stacks such as **Prometheus, Grafana, and Datadog** to ensure performance, stability, and visibility across services.

Currently, I’m part of **Open Innovation AI (OICM)**, where I focus on **MLOps, LLMOps, and AI Infrastructure**, building scalable systems that make **AI model deployment, monitoring, benchmarking, and scaling** effortless across **multi-cluster Kubernetes environments**. My work bridges the gap between backend engineering and machine learning infrastructure — designing developer-friendly, production-grade systems for large-scale AI workloads. I’m passionate about creating infrastructure that simplifies AI adoption for developers while maintaining high standards of reliability, performance, and maintainability.

Before joining OICM, I worked at [**Comera**](https://mycomera.com), a UAE-based real-time messaging platform competing with WhatsApp and Telegram. As **Lead Engineer & Solution Architect**, I led the **XMPP messaging segment** and the **Sustenance Team**, designing and maintaining distributed systems capable of processing millions of messages per day. My team focused on improving reliability, optimizing presence management, and ensuring secure, low-latency communication experiences for users across the globe.

Throughout my career, I’ve taken on multiple leadership roles — including **CTO, Engineering Manager, and Tech Lead** — where I’ve hired, mentored, and managed **cross-functional teams** ranging from small startup squads to large-scale engineering groups of over 100 members. I’m deeply passionate about building healthy engineering cultures that balance speed, quality, and innovation. I take pride in nurturing talent, simplifying complex systems, and leading teams that thrive on collaboration and shared ownership.

Earlier in my journey, I co-led the development of **Evaly**, Bangladesh’s largest e-commerce platform, where I helped architect and scale microservices to handle **7M+ users** and **1M+ requests per minute**. I also contributed to SaaS platforms like **RAENA**, **EkkBaz**, and **Inovio**, gaining experience in multi-tenant architectures, logistics automation, and fintech integrations.

In 2016, my team and I earned the **[Champion title in the People’s Choice category](https://2016.spaceappschallenge.org/challenges/earth/earth-live/projects/agro-skylab-durbar)** at the **[NASA Space Apps Challenge Bangladesh](https://2016.spaceappschallenge.org/challenges/earth/earth-live/projects/agro-skylab-durbar)** for our project *Agro Skylab Durbar* — a satellite-based agricultural data analysis platform designed to empower farmers with real-time insights. This experience reinforced my belief in the power of technology to create meaningful, human-centered impact.

Beyond my professional roles, I occasionally work as a **freelance consultant and technical auditor**, helping teams with system design, infrastructure modernization, and performance optimization. In my free time, I love to **travel**, explore new technologies, and work on **personal and open-source projects** that challenge my thinking, expand my skillset, and allow me to give back to the engineering community.
